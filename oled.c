...
u8 OLED_GRAM[144][8];
static bool g_oledConnected = true;

enum {
    OLED_I2C_ADDRESS = 0x3C,
    OLED_I2C_TIMEOUT_CYCLES = 80000
};
...
{
    uint32_t timeout = OLED_I2C_TIMEOUT_CYCLES;
